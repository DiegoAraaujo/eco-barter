...
// Página "Minha Área" do usuário.
// - Mostra os itens cadastrados pelo usuário logado.
// - Lista propostas recebidas (com opção de aceitar/recusar).
// - Lista propostas enviadas (com opção de remover).
// - Permite remover itens (apenas mock visual, não persiste no DB).
// - Usa o contexto de autenticação (AuthContext) e de trocas (TradeContext).
...
const MyArea = () => {
  ...
  // Atualiza itens quando usuário mudar
  useEffect(() => {
